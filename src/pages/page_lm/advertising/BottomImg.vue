      ...
      <div v-for="(item,i) of uploadList" :key="i">
        <div class="boimg_d2_li fx">
          ...
          <el-upload
            ...
            <div slot="tip" class="el-upload__tip">建议尺寸：1200*120 px 格式为JPG、PNG,且不超过1M</div>
          </el-upload>
        </div>
        <div class="boimg_d2_li fx">
...
export default {
  data () {
    return {
      topTitleList:[{title:'底部广告位'}],    //顶部抬头显示
      qrCodeImgName:'',
      qrCodeImgUrl:'',
      ...
      uploadList:[    //上传列表
        {pic:'',url:'',title:'底部广告1',sortOrder:"1",categoryId:'5',phone:''},
      ],
    };
  },
